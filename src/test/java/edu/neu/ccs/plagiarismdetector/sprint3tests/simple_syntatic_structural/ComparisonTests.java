...
package edu.neu.ccs.plagiarismdetector.sprint3tests.simple_syntatic_structural;
...
public class ComparisonTests {
    ...
    @Test
    public void testSimpleSyntacticChange() {
        ComparisonTestHelper helper = new ComparisonTestHelper("simple_syntatic_structural");
        ...
        assertTrue("LCS Strategy for simple_syntatic_structural",
                typeStatsMap.get(LCS).getMetricList().get(0).getMatchPercentage() > 75);
        assertTrue("NW Strategy value for simple_syntatic_structural",
                typeStatsMap.get(NW).getMetricList().get(0).getMatchPercentage() > 75);
        assertTrue("Weighted Polynomial Strategy value for simple_syntatic_structural",
                typeStatsMap.get(WEIGHTED).getMetricList().get(0).getMatchPercentage() > 75);
        assertTrue("Moss Trained Weights Strategy value for simple_syntatic_structural",
