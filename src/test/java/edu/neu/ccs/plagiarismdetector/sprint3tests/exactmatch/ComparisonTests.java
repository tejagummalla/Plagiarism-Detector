...
package edu.neu.ccs.plagiarismdetector.sprint3tests.exactmatch;
...
public class ComparisonTests {
    ...
    public void testExactMatch() {
        ComparisonTestHelper helper = new ComparisonTestHelper("exactmatch");
        ...
        assertEquals("LCS Strategy value for exact match",
                100.0,
                typeStatsMap.get(LCS).getMetricList().get(0).getMatchPercentage(), 1.0);
        assertEquals("NW Strategy value for exact match",
                100.0,
                typeStatsMap.get(NW).getMetricList().get(0).getMatchPercentage(), 1.0);
        assertEquals("Weighted Polynomial Strategy value for exact match",
                100.0,
                typeStatsMap.get(WEIGHTED).getMetricList().get(0).getMatchPercentage(), 1.0);
        assertEquals("Moss Trained Weights Strategy value for exact match",
                100.0,
