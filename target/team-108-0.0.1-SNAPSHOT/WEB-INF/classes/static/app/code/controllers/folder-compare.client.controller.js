...
(function () {
    angular
        ...
        .controller("FolderCompareController", folderCompareController);

    function folderCompareController($scope, $timeout, $interval, Upload, $stateParams, $uibModal, $log, $document) {
        let vm = this;
        ...
        vm.startAll = function (uploads) {
            vm.error = "";
            vm.result = "";
            vm.doc1 = "";
            vm.doc2 = "";
            for (let i = 0; i < uploads.length; i++) if (isStartable(i, uploads)) vm.startUploadFor(i, uploads);
        };
        ...
        vm.submit = function () {
            if (vm.uploads1.length === 0) {
                vm.error = "Please upload Student 1 folders!";
                return;
            }
            if (vm.uploads2.length === 0) {
                vm.error = "Please upload Student 2 folders!";
                return;
            }
